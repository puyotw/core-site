...
在魔法氣泡中，四顆以上同色的氣泡相連可以消除，而若是消除後、上面的氣泡掉下來，使得另一群四顆以上氣泡相連而消掉，就稱為「連鎖」。連鎖越大，給對手的攻擊也越多，因此，如何快速、有效率地做出連鎖是魔法氣泡的重點技術之一。為了之後文章討論的方便，此文章將連鎖的觸發條件廣泛地歸納成三種[^1]：段差式、插入式、幽靈連鎖。其中，前兩種包含了絕大多數的情況，之後進行實際的連鎖討論時主要也都會用這兩種。
